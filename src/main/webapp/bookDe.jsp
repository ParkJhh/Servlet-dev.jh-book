...
<body>
    ...
    <p></p>
    <a href=http://localhost:8080/jsp_book_war_exploded/bookSet.jsp >  3)도서 등록 페이지로</a>
    <p></p>
    <a href=http://localhost:8080/jsp_book_war_exploded/bookRe.jsp >  4)도서 수정 페이지로</a>
    <p></p>
    <hr>
    <h1> 도서 삭제는 여기서! </h1>
    <form  action="BookDe" method="get">
        <label>책 타입 : </label>
